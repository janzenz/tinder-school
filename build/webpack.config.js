...
const {__DEV__, __PROD_GOODLAB__, __PROD__, __TEST__} = config.globals
const applicationVersion = 'timestamp';
...
webpackConfig.output = {
  filename: `[name].${applicationVersion}.js`,
  path: paths.dist(),
...
webpackConfig.plugins = [
  ...
  new HtmlWebpackPlugin({
    ...
    hash: false,
    favicon: paths.client('static/goodwall.ico'),
    filename: 'index.html',
    inject: 'body',
    minify: {
...
} else if (__PROD__ || __PROD_GOODLAB__) {
...
// Loader for React debug/perf tools
if(__DEV__) {
...
if (!__DEV__) {
  ...
  webpackConfig.plugins.push(
    new ExtractTextPlugin(`[name].${applicationVersion}.css`, {
      allChunks: true
    })
  )
}
